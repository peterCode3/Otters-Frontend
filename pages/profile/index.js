      ...
      <div className="flex gap-8 w-full max-w-5xl">
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center">
          <img
            ...
            alt="User Logo"
            className="w-28 h-28 rounded-full border-4 border-[#f7b731] object-cover shadow mb-4"
          />
          <div className="w-full">
            <h2 className="text-lg font-semibold text-gray-800 mb-1 flex items-center gap-2">
              <FontAwesomeIcon icon={faUser} className="text-[#f7b731]" />
              {edit ? (
            ...
            <div className="text-gray-500 mb-2 flex items-center gap-2">
              <FontAwesomeIcon icon={faEnvelope} className="text-[#f7b731]" />
              {edit ? (
                <div className="flex flex-col w-full">
            ...
            <div className="flex gap-3 mt-4">
              {edit ? (
                <>
                  <button
                    className="bg-[#f7b731] text-white px-6 py-2 rounded-full font-semibold shadow hover:bg-[#e2a500] transition"
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-lg p-8 flex flex-col">
          ...
          <div className="flex-1 space-y-3">
            {detailFields.map(({ key, label, icon }) => (
              <div key={key} className="flex items-center gap-3">
                <FontAwesomeIcon icon={icon} className="text-[#f7b731]" />
          ...
          <div className="mt-8">
            <h4 className="text-md font-semibold text-gray-700 mb-2 flex items-center gap-2">
              <FontAwesomeIcon icon={faLock} className="text-[#f7b731]" />
              Reset Password
            </h4>
            <input
              className="w-full border border-gray-200 rounded-lg px-3 py-2 mb-2 focus:outline-none focus:ring-2 focus:ring-[#f7b731]"
              type="password"
            ...
            />
            <button
              className="bg-[#f7b731] text-white px-6 py-2 rounded-full font-semibold shadow hover:bg-[#e2a500] transition w-full"
